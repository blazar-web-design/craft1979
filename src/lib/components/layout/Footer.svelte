...
<footer class="border-t-2 border-forest-800 bg-forest-950">
  <div class="mx-auto max-w-6xl px-4 py-10 sm:px-6">
    ...
    <p
      class="mt-6 text-center text-xs leading-relaxed text-fog/50 md:text-left"
    >
      {site.name} episodes are AI-generated by Latent Diffusion. This fan site is
      built with AI-assisted tooling and reviewed by humans before it ships.
    </p>
  </div>
</footer>
